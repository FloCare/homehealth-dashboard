...
import { PhysicianList, PhysicianCreate, PhysicianEdit } from './physicians';
...
const App = () => (
    ...
    >
        ...
        <Resource name="physicians" options={{label: 'Physicians'}} list={PhysicianList} create={PhysicianCreate} icon={UserIcon} />
    </Admin>
);
